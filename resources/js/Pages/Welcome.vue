        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                <div class="flex text-gray-100 ">
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex flex-col justify-end">
                        <JetNavLink class="text-5xl pb-[26px]" :href="route('test1')" :active="route().current('test1')">
                            Test1
                        </JetNavLink>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex flex-col justify-end">
                        <JetNavLink class="text-5xl pb-[26px]" :href="route('test2')" :active="route().current('test2')">
                            Test2
                        </JetNavLink>
                    </div>
                </div>
